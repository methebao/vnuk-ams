...
detector = cv2.CascadeClassifier('./models/haarcascade_frontalface_default_2.xml')
...
def updateToMongo(eventId,studentId,checkInTimestamp,frame):
    ...
    result = events.update_one({"eventId": eventId, "students": {
      "$elemMatch":{"studentId": studentId}
        ...
        "$set": {
            ...
            "students.$.checkInTime": checkInTimeFormatted
        }
    })
